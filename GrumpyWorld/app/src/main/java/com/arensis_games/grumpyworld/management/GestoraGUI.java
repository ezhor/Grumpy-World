package com.arensis_games.grumpyworld.management;
...
public class GestoraGUI {
    public Drawable getDrawableSombrero(Resources resources, String nombre) {
        ...
        if (nombre != null) {
            switch (nombre) {
                case "casco_obra":
                    drawable = resources.getDrawable(R.drawable.sombrero_casco_obra);
                    break;
                case "casco_calabaza":
    ...
    public Drawable getDrawableArma(Resources resources, String nombre) {
        Drawable drawable = null;
        if (nombre == null) {
            drawable = resources.getDrawable(R.drawable.arma_nada);
        } else {
            switch (nombre) {
                case "revientaencias":
                    drawable = resources.getDrawable(R.drawable.arma_revientaencias);
                    break;
                case "mazo_juez":
        ...
        if (enemigo != null) {
            switch (enemigo) {
                ...
                case "cuchilla":
                    ...
                    break;
                case "hambriento":
                    drawable = resources.getDrawable(R.drawable.enemigo_hambriento);
                    break;
                case "vater":
                ...
                case "raton":
                    drawable = resources.getDrawable(R.drawable.enemigo_raton);
                    break;
                case "grapadora":
                    drawable = resources.getDrawable(R.drawable.enemigo_grapadora);
                    break;
                case "lapiz":
                    drawable = resources.getDrawable(R.drawable.enemigo_lapiz);
                    break;
                case "libro":
                    drawable = resources.getDrawable(R.drawable.enemigo_libro);
                    break;
                case "pendrive":
                    drawable = resources.getDrawable(R.drawable.enemigo_pendrive);
                    break;
            }
        }
        return drawable;
    ...
    public String getNombreCortoEnemigo(Resources resources, String enemigo) {
        ...
        switch (enemigo) {
            ...
            case "raton":
                nombreCorto = resources.getString(R.string.enemigo_raton_corto);
                break;
            case "grapadora":
                nombreCorto = resources.getString(R.string.enemigo_grapadora_corto);
                break;
            case "lapiz":
                nombreCorto = resources.getString(R.string.enemigo_lapiz_corto);
                break;
            case "libro":
                nombreCorto = resources.getString(R.string.enemigo_libro_corto);
                break;
            case "pendrive":
                nombreCorto = resources.getString(R.string.enemigo_pendrive_corto);
                break;
        }
        return nombreCorto;
    }
        ...
        if (nombre != null) {
            switch (nombre) {
                ...
                case "trozo_calabaza":
                    ...
                    break;
                case "zumo_limon":
                    nombreBonito = resources.getString(R.string.material_zumo_limon);
                    break;
                case "grapa":
                    nombreBonito = resources.getString(R.string.material_grapa);
                    break;
                case "zinc":
                    nombreBonito = resources.getString(R.string.material_zinc);
                    break;
                case "cable":
                    nombreBonito = resources.getString(R.string.material_cable);
                    break;
                case "cobre":
                    nombreBonito = resources.getString(R.string.material_cobre);
                    break;
                case "bateria":
                    nombreBonito = resources.getString(R.string.material_bateria);
                    break;
                case "papel":
    ...
    public String getNombreEquipable(Resources resources, String nombre) {
        ...
        switch (nombre) {
            ...
            case "casco_calabaza":
                ...
                break;
            case "pistola_airsoft":
                nombreBonito = resources.getString(R.string.equipable_pistola_airsoft);
                break;
            case "sombrero_papel":
                nombreBonito = resources.getString(R.string.equipable_sombrero_papel);
                break;
